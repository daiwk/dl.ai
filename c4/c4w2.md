...
- [1. Case studies](#1-case-studies)
    ...
    - [1.5 Networks in Networks and 1x1 Convolutions（2013年）](#15-networks-in-networks-and-1x1-convolutions%EF%BC%882013%E5%B9%B4%EF%BC%89)
    - [1.6 Inception Network Motivation（2014年）](#16-inception-network-motivation%EF%BC%882014%E5%B9%B4%EF%BC%89)
...
- [2. Practical advices for using ConvNets](#2-practical-advices-for-using-convnets)
    ...
    - [2.2 Transfer Learning](#22-transfer-learning)
        - [2.2.1 如果训练集较小](#221-%E5%A6%82%E6%9E%9C%E8%AE%AD%E7%BB%83%E9%9B%86%E8%BE%83%E5%B0%8F)
        - [2.2.2 如果训练集很大](#222-%E5%A6%82%E6%9E%9C%E8%AE%AD%E7%BB%83%E9%9B%86%E5%BE%88%E5%A4%A7)
        - [2.2.3 如果训练集特别大](#223-%E5%A6%82%E6%9E%9C%E8%AE%AD%E7%BB%83%E9%9B%86%E7%89%B9%E5%88%AB%E5%A4%A7)
...
![why-1x1-convs-do.png](../c4/imgs/why-1x1-convs-do.png)
...
![using-1x1-conv.png](../c4/imgs/using-1x1-conv.png)
...
![motivation-for-inception-network.png](../c4/imgs/motivation-for-inception-network.png)
...
![inception-computation-cost.png](../c4/imgs/inception-computation-cost.png)
...
![using-1x1-conv-for-5x5.png](../c4/imgs/using-1x1-conv-for-5x5.png)
...
![inception-network.png](../c4/imgs/inception-network.png)
...
例如需要搞一个三分类问题，可以找一个开源的实现，并把训练好的参数搞下来。
...
![transfer-learning.png](../c4/imgs/transfer-learning.png)
...
另一种是Color shifting(色彩变化)，在R/G/B分别加上不同的扰动，图中+/-20只是为了看得更明显一点，实际的扰动可能很小。
...
![color-shifting.png](../c4/imgs/color-shifting.png)
