...
![numerical-approximation-of-gradients.png](https://raw.githubusercontent.com/daiwk/dl.ai/master/c2/imgs/numerical-approximation-of-gradients.png)
...
![gradient-check-for-a-neural-network.png](https://raw.githubusercontent.com/daiwk/dl.ai/master/c2/imgs/gradient-check-for-a-neural-network.png)

gradient check的步骤如下（$\epsilon$常取$10^{-7}$）,当下式约等于$10^{-7}$时，应该没问题，如果大于$10^{-3}$，很可能有问题。

$$ \frac{||d\theta_{approx}-d\theta||_2}{||d\theta_{approx}||_2+||d\theta||_2} $$

![gradient-check.png](https://raw.githubusercontent.com/daiwk/dl.ai/master/c2/imgs/gradient-check.png)
...
![gradient-check-implementation-notes.png](https://raw.githubusercontent.com/daiwk/dl.ai/master/c2/imgs/gradient-check-implementation-notes.png)
