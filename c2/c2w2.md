...
- [1. optimization algorithms](#1-optimization-algorithms)
    - [1.1. mini-batch gradient descent](#11-mini-batch-gradient-descent)
    - [1.2. understanding mini-batch gradient descent](#12-understanding-mini-batch-gradient-descent)
    - [1.3. exponentially weighted averages](#13-exponentially-weighted-averages)
    - [1.4. understanding exponentially weighted averages](#14-understanding-exponentially-weighted-averages)
    - [1.5. bias correction in exponentially weighted averages](#15-bias-correction-in-exponentially-weighted-averages)
    - [1.6. gradient descent with momentum](#16-gradient-descent-with-momentum)
    - [1.7. RMSprop](#17-rmsprop)
    - [1.8. Adam optimization algorithm](#18-adam-optimization-algorithm)
    - [1.9. learning rate decay](#19-learning-rate-decay)
    - [1.10. the problem of local optima](#110-the-problem-of-local-optima)
...
![mini-batch-gradient-descent-introduction.png](../c2/imgs/mini-batch-gradient-descent-introduction.png)
...
![mini-batch-gradient-descent.png](../c2/imgs/mini-batch-gradient-descent.png)

## 1.2. understanding mini-batch gradient descent

可见，使用mini-batch的cost会有不小的抖动和噪音。

![mini-batch-gradient-descent-cost.png](../c2/imgs/mini-batch-gradient-descent-cost.png)
...
![mini-batch-gradient-descent-choose-batchsize.png](../c2/imgs/mini-batch-gradient-descent-choose-batchsize.png)
...
![mini-batch-gradient-descent-choose-size.png](../c2/imgs/mini-batch-gradient-descent-choose-size.png)
...
![exponential-weight-average-introduction.png](../c2/imgs/exponential-weight-average-introduction.png)
...
![exponential-weight-average-formula.png](../c2/imgs/exponential-weight-average-formula.png)
...
![exponential-weight-average-analyze.png](../c2/imgs/exponential-weight-average-analyze.png)

好处：
+ 计算简单
+ 省内存（只需要存一个变量v就行了）

![exponential-weight-average-implementation.png](../c2/imgs/exponential-weight-average-implementation.png)
...
![exponential-weight-average-bias-correction.png](../c2/imgs/exponential-weight-average-bias-correction.png)
...
![momentum-introduction.png](../c2/imgs/momentum-introduction.png)
...
![momentum-implementatioin.png](../c2/imgs/momentum-implementatioin.png)
...
![rmsprop.png](../c2/imgs/rmsprop.png)

## 1.8. Adam optimization algorithm

![adam.png](../c2/imgs/adam.png)
...
![adam-hyperparameter.png](../c2/imgs/adam-hyperparameter.png)
...
![learning-rate-decay-formula1.png](../c2/imgs/learning-rate-decay-formula1.png)

其他方法：

+ $\alpha = 0.95^{epoch\_num}\alpha_0$：exponentially decay
+ $\alpha = \frac{k}{\sqrt{epoch\_num}}\alpha_0$或者$\alpha=\frac{k}{\sqrt{t}\alpha_0}$其中的t是第t个mini-batch
+ descrete staircase：随epoch或者t的变化，每次学习率变为之前的一半

![learning-rate-decay-other-methods.png](../c2/imgs/learning-rate-decay-other-methods.png)
...
![local-optima-in-nn.png](../c2/imgs/local-optima-in-nn.png)
...
![plateaus.png](../c2/imgs/plateaus.png)